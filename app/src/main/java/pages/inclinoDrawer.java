...
public class inclinoDrawer {
    ...
    private SensorValue mSensorValue = new SensorValue();
    ...
    public inclinoDrawer(@NonNull Context context) {
  ...
  //      drawSunTime(canvas);
    ...
    private void initPaint() {
        ...
        mDirectionTextPaint.setTextSize(realPx(30));
    ...
    private void drawMagnetic(Canvas canvas) {
        ...
        drawText(canvas, 60, "camp.mag", 445, mSecondaryTextPaint);
    }
