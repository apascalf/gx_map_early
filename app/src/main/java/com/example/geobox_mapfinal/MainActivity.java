...
import pages.CompassFragmentt;
import pages.LayersFragment;
import pages.MappFragment;
import pages.mapgFragment;
import utils.AppSettingsConstants;
...
public class MainActivity extends NGActivity
        implements GpsEventListener, IChooseLayerResult, MappFragment.OnFragmentInteractionListener
{
    ...
    protected MappFragment mMapFragment;
...
/*
        ...
        mMapFragment = (MappFragment) fm.findFragmentById(R.id.map);
...
*/
    ...
    public void showEditToolbar() {
        ...
        boolean visible = mMapFragment.getMode() != MappFragment.MODE_EDIT_BY_WALK;
    ...
    public MappFragment getMapFragment() {
        return mMapFragment;
    }
...
public class MainActivity extends AppCompatActivity
        ...
        mapgFragment.OnFragmentInteractionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // checksensors();
        ...
        CompassFragmentt cf = new CompassFragmentt();
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.replace(R.id.container_view, cf);
    ...
    public void checksensors() {
        System.out.println("COMPROBANDO SENSORES");
        if (SensorUtil.hasAccelerometer(this)) {
            System.out.println("-EXISTE ACCELEROMETRO");
        } else {
            System.out.println("-NO EXISTE ACCELEROMETRO");
        }
        if (SensorUtil.hasGravitySensor(this)) {
            System.out.println("-EXISTE SENSOR DE GRAVEDAD");
        } else {
            System.out.println("-NO EXISTE SENSOR DE GRAVEDAD");
        }
        if (SensorUtil.hasMagnetometer(this)) {
            System.out.println("-EXISTE MAGNEROMETRO");
        } else {
            System.out.println("-NO EXISTE MAGNEROMETRO");
        }
        if (SensorUtil.hasRotationVector(this)) {
            System.out.println("-EXISTE VECTOR DE ROTACION");
        } else {
            System.out.println("-NO EXISTE VENCTOR DE ROTACION");
        }
    }
    ...
    public void checkpermissions() {
        TedPermission.with(this)
                ...
                .setDeniedMessage("Si denegas los permisos no podras utilizar esta aplicacion\n\nPor favor habilita los permisos en [Opciones] > [Permisos]")
    ...
    PermissionListener permissionlistener = new PermissionListener() {
        ...
        public void onPermissionGranted() {
            Toast.makeText(MainActivity.this, "Permisos obtenidos", Toast.LENGTH_SHORT).show();
        }
